 ...
 * @author Mateo
 */
public class EnergyBullet_Enemy extends ABullet {

    //path para la imagen
    private static String pathurl = "bullets/energiacolores.png";

    public EnergyBullet_Enemy() {
        super();
        this.img = new Image(getClass().getResourceAsStream("/" + EnergyBullet_Enemy.pathurl));

    }

    @Override
    public void init(Coordenada c, Rectangle board) {
        super.init(8, new Size(23, 24), c, true, true, board);
    }

    @Override
    public void draw(GraphicsContext gc) {

        gc.drawImage(img, 48, 0, this.getSize().getWidth() / 1.5, this.getSize().getHeight() / 1.5,
